...
import (
	...
	_06_solomachine "github.com/cosmos/ibc-go/v7/modules/light-clients/06-solomachine"
...
type GenesisState struct {
	...
	ProviderClientState *_06_solomachine.ClientState `protobuf:"bytes,5,opt,name=provider_client_state,json=providerClientState,proto3" json:"provider_client_state,omitempty"`
	// ProviderConsensusState filled in on new chain, nil on restart.
	ProviderConsensusState *_06_solomachine.ConsensusState `protobuf:"bytes,6,opt,name=provider_consensus_state,json=providerConsensusState,proto3" json:"provider_consensus_state,omitempty"`
...
func (m *GenesisState) GetProviderClientState() *_06_solomachine.ClientState {
	if m != nil {
...
func (m *GenesisState) GetProviderConsensusState() *_06_solomachine.ConsensusState {
	if m != nil {
...
var fileDescriptor_2db73a6057a27482 = []byte{
	...
	,
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.ProviderClientState == nil {
				m.ProviderClientState = &_06_solomachine.ClientState{}
			}
		...
		case 6:
			...
			if m.ProviderConsensusState == nil {
				m.ProviderConsensusState = &_06_solomachine.ConsensusState{}
			}
